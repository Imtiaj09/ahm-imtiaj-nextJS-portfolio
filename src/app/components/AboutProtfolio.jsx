...
// Skills, Education, Certifications- Tab Handaling 
function AboutProtfolio() {
  ...
  return (
    <section className="text-white" id="about">
      <div className="grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/imtiaj.jpeg" alt="#" width={500} height={500} />
